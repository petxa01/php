      ...
      <div id="navlist-container">
        <div id="navlist">
          <ul>
            ...
            <li class="current_page_item"><a href="#">Erregistratu</a></li>
            <li><a href="Ezabatu.php">Ezabatu</a></li>
          </ul>
        </div>
      </div>
    ...
    <div  id="content">
      <div class="post-container">
        <div class="post" id="post-3">
          <div class="posttop">
            <h2><a href="#"> Enter a new car </a></h2>
          </div>
          <div class="entry">
            <div class="content">
              <form action="insert_cars.php" method="post">
                <table style="color: black;">
                  <tr>
                    <td>chassis_number:
                    </td>
                    <td><input type="text" name="chassis_number">
                    </td>
                  </tr>
                  <tr>
                    <td>Brand:
        ...
        <div class="post" id="post-1">
          <div class="posttop">
            ...
            <div class="postinfo">
              <div class="posted"> Filed under: <a href="#">Templates</a> </div>
              <div class="published"> 26 July 2008 </div>
            </div>
          </div>
          <div class="entry">
            <p>Hendreritid consectetuer pellus quis libero justo morbi ut justo condis dui. Interdummagna nulla fametuer vel sem mollicitur vel quismodo mattitor rutrum magna. Quisipsum pellentum risus congue euis sodalesuada a nibh nam faucibus phasellentesque. Curabiturpisciniaac nibh velis sit at eros dignisl urna libero congue euisque. Habiturnunc trisus vestibulum aenean elit et ipsum rhoncus urna felit morbi.</p>
          </div>
          <div class="postbottom">
            <div class="rssfeed"> <a href="#">RSS</a> </div>
            <div class="comments"> <a href="#">1 Comment</a> </div>
          </div>
        </div>
      </div>
