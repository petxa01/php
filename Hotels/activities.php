...
<!-- start main_content -->
				<ul class="service_list">
					<li>
						...
						<a href="details.php"><h3>Sed condimentum</h3></a>
						<p class="para">There are many variations of passages of Lorem Ipsum available,</p>
						<h4><a  href="details.php">Lorem ipsum</a></h4>
					</li>
					<li>
						<div class="ser_img">
							<a href="details.php">
						...
						<a href="details.php"><h3>Integer facilisis</h3></a>
						 <p class="para">Our website design and development provides quality web,</p>
						 <h4><a href="details.php">Nulla accumsan</a></h4>
					</li>
					<li>
						<div class="ser_img">
							<a href="details.php">
						 ...
						 <a href="details.php"><h3>Morbi sit amet mauris</h3></a>
						 <p class="para">There are many variations of passages of Lorem Ipsum available,</p>
						 <h4><a href="details.php">Vestilum feliing</a></h4>
					</li>
					<li>
						<div class="ser_img">
							<a href="details.php">
						...
						<a href="details.php"><h3>Nulla commodo erat</h3></a>
						 <p class="para">Lorem ipsum dolor sit amet, consectetur elit,EIUSMOD tempor,</p>
						 <h4><a href="details.php">Nulla commodo</a></h4>
					</li>
					<div class="clear"></div>
				</ul>
